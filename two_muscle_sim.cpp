...
/// OM 1
    ...
    connect_one_to_all(CV1, OM1_0, 1.5, 0.75 * quadru_coef * sero_coef);
    connect_one_to_all(CV2, OM1_0, 1, 0.09* quadru_coef * sero_coef);
...
//    connect_one_to_all(CV4, OM1_0, 0.5, 0.001 * quadru_coef * sero_coef);
    ...
    // E1
    connect_fixed_outdegree(E1, OM1_0, 1, 0.9); // 3
    // inner connectomes
    connect_fixed_outdegree(OM1_0, OM1_1, 0.2, 0.5);
    connect_fixed_outdegree(OM1_1, OM1_2_E, 0.5, 0.9 );//*2
    connect_fixed_outdegree(OM1_1, OM1_2_F, 1, 0.9);
    connect_fixed_outdegree(OM1_1, OM1_3, 1, 0.000009); // 0.9
    connect_fixed_outdegree(OM1_2_E, OM1_1, 2.5, 0.4);
    connect_fixed_outdegree(OM1_2_F, OM1_1, 2.5, 0.8);
    connect_fixed_outdegree(OM1_2_E, OM1_3, 1, 0.000009 );//*4
    connect_fixed_outdegree(OM1_2_F, OM1_3, 1, 0.000008 );//*2
    connect_fixed_outdegree(OM1_3, OM1_1, 0.3, -0.00000001 * inh_coef);
